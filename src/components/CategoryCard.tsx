...
const CategoryCard = ({
  ...
  return <Card onClick={() => navigate(`/${category.toLowerCase().replace(/\s+/g, '-')}`)} className="glass-card cursor-pointer group border-border/50 overflow-hidden rounded-2xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.02] md:aspect-square flex flex-col min-h-[320px] mx-0 py-[30px] px-[15px]">
