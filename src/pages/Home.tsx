...
const Home = () => {
  ...
  return <div className="min-h-screen">
      ...
      {/* Filters Section */}
      <section className="pt-32 pb-6 px-6 md:px-8 bg-gray-400">
      ...
      {/* Category Cards */}
      {showCategoryCards && !loading && categories.length > 0 && <section className="pb-20 px-6 my-0 bg-gray-400">
      ...
      <section className="pb-20 px-6 md:px-8 bg-gray-400">
